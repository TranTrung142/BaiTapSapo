...
public class BidvAtm implements Atm {
    ...
    private BigDecimal moneyAtm = new BigDecimal(10000000);

    //private Printer printer = new PrinterConsole();

    @Override
    public void withDraw(Customer customer, BigDecimal amount) {
        //a.compareTo(b) so sanh chuoi a va chuoi b, neu a>b thi tra ve duong, nguoc lai a<b la am.
        ...
        printer.printMessage("Ban da rut tien thanh cong!!!");
    }
    ...
    public void deposit(Customer customer, BigDecimal amount) {
        ...
        printer.printMessage("Ban da gui tien thanh cong!!!");
    }
